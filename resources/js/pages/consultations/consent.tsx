                        ...
                        <div className="rounded-xl border">
                            <div className="border-b px-5 py-3">
                                ...
                                <p className="mt-0.5 text-xs text-muted-foreground">
                                    Please review the full document before
                                    confirming.
                                </p>
                            </div>
                            ...
                            <div className="h-520px overflow-y-auto px-5 py-4 text-sm leading-relaxed">
                                ...
                                <p className="mb-4 text-muted-foreground">
                                    This Privacy Notice explains how AMPING
                                    Telekonsulta collects, uses, and protects
                                    your personal information in connection with
                                    your teleconsultation session.
                                </p>
                                ...
                                <ul className="mb-4 list-disc pl-5 text-muted-foreground">
                                    <li>
                                        Identity information (name, date of
                                        birth, valid ID)
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Video, audio, and image data captured
                                        during the session
                                    </li>
                                    <li>
                                        Device metadata and connection
                                        information
                                    </li>
                                    <li>
                                        AI-assisted liveness verification and
                                ...
                                <ul className="mb-4 list-disc pl-5 text-muted-foreground">
                                    ...
                                    <li>
                                        To facilitate a secure real-time
                                        teleconsultation
                                    </li>
                                    <li>
                                        To generate and store clinical records
                                        (SOAP notes, prescriptions, vitals)
                                    </li>
                                    <li>
                                        To detect and flag potential deepfake or
                                        impersonation attempts
                                    </li>
                                    <li>
                                        To comply with applicable health
                                        information laws and regulations
                                    </li>
                                </ul>

                                <h3 className="mb-1 font-semibold">
                                    3. Identity Guard Verification
                                </h3>
                                <p className="mb-4 text-muted-foreground">
                                    As part of this consultation, AMPING
                                    Telekonsulta employs Identity Guard
                                    technology to confirm your identity in real
                                    time. This includes facial recognition
                                    matching against your registered profile.
                                    Your biometric data is processed solely for
                                    verification purposes and is not shared with
                                    third parties without your explicit consent,
                                    except as required by law.
                                </p>

                                <h3 className="mb-1 font-semibold">
                                    4. Liveness &amp; Security Checks
                                </h3>
                                <p className="mb-4 text-muted-foreground">
                                    Anti-spoofing and liveness detection checks
                                    may be performed automatically during the
                                    session to ensure the integrity of the
                                    teleconsultation. Results of these checks
                                    are logged and may be reviewed by authorised
                                    medical staff.
                                </p>
                                ...
                                <p className="mb-4 text-muted-foreground">
                                    Personal and clinical data is retained in
                                    accordance with applicable medical records
                                    laws. You may request access, correction, or
                                    deletion of your data by contacting the
                                ...
                                <p className="mb-4 text-muted-foreground">
                                    For questions about this Privacy Notice or
                                    your personal data, please contact the
                                    AMPING Telekonsulta Data Protection Officer
                                    via the platform's support channel.
                                </p>

                                <p className="mt-6 text-xs text-muted-foreground">
                                    Last updated: March 2026. This document is
                                    for informational purposes. By confirming
                                    consent, you acknowledge that you have read,
